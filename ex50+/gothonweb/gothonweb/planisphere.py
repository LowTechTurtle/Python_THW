...
cc_death_shoot = room("Central Corridor Death Shoot", '''
...
cc_death_dodge = room('Central Corridor Death Dodge','''
...
laser_weapon_armory_death = room('Laser Weapon Armory Death', '''
...
the_bridge_death = room('The Bridge Death', '''
...
death_choice = ["You died. You kinda suck at this.",
"Your Mom would be proud...if she were smarter.",
"Such a luser.",
"I have a small puppy that's better at this.",
"You're worse than your Dad's jokes." ]

generic_death = room("death", choice(death_choice))
cc_death_shoot.add_paths({'*': generic_death})
cc_death_dodge.add_paths({'*': generic_death})
laser_weapon_armory_death.add_paths({'*': generic_death})
the_bridge_death.add_paths({'*': generic_death})
...
'shoot!': cc_death_shoot,
'dodge!': cc_death_dodge,
